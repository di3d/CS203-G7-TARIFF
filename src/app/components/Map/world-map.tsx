...
export function WorldMap({ countries, tradeAgreements }: WorldMapProps) {
        ...
        <div class="text-sm mb-1">
          <span class="font-medium">Base Tariff Rate:</span> ${
            ...
            if (agreements.length > 0) {
                ...
                const avgRate = (
                    agreements.reduce((sum, a) => sum + a.rate, 0) / agreements.length
                ).toFixed(1);
          ...
          <div class="font-medium text-gray-700 dark:text-gray-300 mb-1">Top Partners:</div>`;
            ...
            <span class="text-gray-600 dark:text-gray-400"> - ${
                        partnerAgreements.length
                    } ${partnerAgreements.length === 1 ? "agreement" : "agreements"}, avg: ${partnerAvgRate}%</span>
          </div>`;
                });
    ...
    const getFillColor = (geo: CountryFeature) => {
        ...
        if (!countryData || countryData.tariffRate == null) return "#E5E7EB";
